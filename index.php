        ...
        <main class="main">
                        ...
                        <div class="home__img">
                            <svg class="home__blob" viewBox="0 0 200 187" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                ...
                                <g mask="url(#mask0)">
                                    ...
                                    <image class="home__blob-img" X="12" Y="18" xlink:href="assets/img/"/>
                                </g>
                            </svg>
                        </div>
            ...
            <section class="about section" id="about">
                ...
                <div class="about__container container grid">
                    <img src="assets/img/bg.jpeg" alt="" class="about__img">
                    ...
                    <div class="qualification__sections">
                        ...
                        <div class="qualification__content qualification__active" data-content id="education">
                            ...
                            <div class="qualification__data">
                                <div>
                                    <h3 class="qualification__title">Mathematical Science</h3>
                                    <span class="qualification__subtitle">Kwara State University, Nigeria</span>
                            ...
                            <div class="qualification__data">
                                ...
                                <div>
                                    <h3 class="qualification__title"> TiideLab Prefellowship - Web Design</h3>
                                    <span class="qualification__subtitle">Lagos State, Nigeria</span>
                                    <div class="qualification__calender">
                                        <i class="uil uil-calendar-alt"></i>
                                            2022 - 1 month
                                    </div>
                            ...
                            <div class="qualification__data">
                                <div>
                                    ...
                                    <span class="qualification__subtitle">Self Learning Udemy, Youtube</span>
                                    <div class="qualification__calender">
                                        <i class="uil uil-calendar-alt"></i>
                                            2024 - till current
                                    </div>
                        ...
                        <div class="qualification__content" data-content id="work">
                            ...
                            <div class="qualification__data">
                                ...
                                <div>
                                    <h3 class="qualification__title">Customer Care Representative</h3>
                                    <span class="qualification__subtitle">Abusidiq Digitals - Lagos Nigeria</span>
                                    <div class="qualification__calender">
                                        <i class="uil uil-calendar-alt"></i>
                                        2018 - 2020
                                    </div>
                            ...
                            <div class="qualification__data">
                                <div>
                                    <h3 class="qualification__title">Junior Financial Analyst</h3>
                                    <span class="qualification__subtitle">Jiayou Outsourcing Company - Lagos, Nigeira</span>
                                    <div class="qualification__calender">
                                        <i class="uil uil-calendar-alt"></i>
                                        2021 - 2023
                                    </div>
                              ...
                              <div class="qualification__data">
                                ...
                                <div>
                                    <h3 class="qualification__title"> Domestic Assistant NHS</h3>
                                    <span class="qualification__subtitle">NMGH - Manchester, United Kingdom</span>
                                    <div class="qualification__calender">
                                        <i class="uil uil-calendar-alt"></i>
                                        2023 - Till current
                                    </div>
            ...
            <section class="services section" id="services">
                ...
                <div class="services__container container grid">
                    ...
                    <div class="services__content">
                        ...
                        <div class="services__modal">
                            <div class="service__modal-content">
                                <h4 class="service__modal-title">Frontend <br> Developer</h4>
                                ...
                                <ul class="services__modal-services grid">
                                    ...
                                    <li class="services__modal-service">
                                        <i class="uil uil-check-circle services__modal-icon"></i>
                                        <p>I create web element intaractions</p>
                                    </li>
                                    <li class="services__modal-service">
                                        <i class="uil uil-check-circle services__modal-icon"></i>
                                        <p>Positioning of your company's brand</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="services__content">
                        ...
                        <div class="services__modal">
                            <div class="service__modal-content">
                                <h4 class="service__modal-title">Backend <br> Developer</h4>
                                <i class="uil uil-times services__modal-close"></i>
                    ...
                    <div class="services__content">
                        ...
                        <div class="services__modal">
                            <div class="service__modal-content">
                                <h4 class="service__modal-title">Branding <br> Designer</h4>
                                <i class="uil uil-times services__modal-close"></i>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="portfolio__content grid swiper-slide">
                            ...
                            <div class="portfolio__data">
                                <h3 class="portfolio__title">CMS Blog System</h3>
                                <p class="portfolio__description">CMS Blog Lorem ipsum dolor, sit amet consectetur adipisicing elit. Amet, numquam!</p>
                        ...
                        <div class="portfolio__content grid swiper-slide">
                            ...
                            <div class="portfolio__data">
                                <h3 class="portfolio__title">Personal Portfolio</h3>
                                <p class="portfolio__description">Portfolio Lorem ipsum dolor, sit amet consectetur adipisicing elit. Amet, numquam!</p>
                                <a href="#" class="button button--flex button--small portfolio__button">
                                    Preview
                                    <i class="uil uil-arrow-right button__icon"></i>
                                </a>
                        ...
                        <div class="portfolio__content grid swiper-slide">
                            ...
                            <div class="portfolio__data">
                                <h3 class="portfolio__title">Photo Gallery PHP</h3>
                                <p class="portfolio__description">Gallery Lorem ipsum dolor, sit amet consectetur adipisicing elit. Amet, numquam!</p>
                                <a href="#" class="button button--flex button--small portfolio__button">
                                    Preview
                                    <i class="uil uil-arrow-right button__icon"></i>
                                </a>
            ...
            <section class="project section">
                ...
                <span class="section__subtitle">Recent Articles</span>
            </section>
                        ...
                        <div class="testimonial__content swiper-slide">
                            <div class="testimonial__data">
                                <div class="testimonial__header">
                                    <img src="assets/img/portfolio3.jpg" alt="" class="testimonial__img">
                                    <div>
                                        <h3 class="testimonial__name">Abubakar Sidiq</h3>
                                        <span class="testimonial__client">Mentor</span>
                                    </div>
                                </div>
                                <div>
                            ...
                            <p class="testimonial__description">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum repellendus nam illum, maxime neque accusantium suscipit.
                            </p>
                        </div>
                        <!--==================== TESTIMONIAL 2 ====================-->
                        <div class="testimonial__content swiper-slide">
                            <div class="testimonial__data">
                                <div class="testimonial__header">
                                    <img src="assets/img/ola.jpeg" alt="" class="testimonial__img">
                                    <div>
                                        <h3 class="testimonial__name">Agboola Tawakalit</h3>
                                        <span class="testimonial__client">Wife</span>
                                    </div>
                                </div>
                                <div>
                                    <i class="uil uil-star testimonial__icon-star"></i>
                        ...
                        <div class="testimonial__content swiper-slide">
                            <div class="testimonial__data">
                                <div class="testimonial__header">
                                    <img src="assets/img/portfolio3.jpg" alt="" class="testimonial__img">
                                    <div>
                                        <h3 class="testimonial__name">Muhammed AbdulKabir</h3>
                                        <span class="testimonial__client">Financial Engineer</span>
                                    </div>
                                </div>
                                <div>
                                    <i class="uil uil-star testimonial__icon-star"></i>
